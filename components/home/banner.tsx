    ...
    <section className="min-h-screen h-screen flex flex-col">
      ...
      <div className="flex flex-1 h-full relative">
        ...
        <div className="flex-1 md:flex-[.8]">
          <Image src={'/banner.png'} width={900} height={800} alt="banner" className="w-full h-full object-cover object-center" />
        </div>

        <div className="absolute top-[55%] translate-y-[-50%] left-[-30px] z-[4] py-10 px-16 rounded-[35px] text-white bg-main-gradient w-[90vw] max-w-[550px]">
